...
from embed import EmbeddingLearned as Embedding
...
class Network(nn.Module):
    ...
    def __call__(self, en_in, training: bool = False):
        ...
        en_out = Encoder(vocab_size=self.vocab_size,
                         ...
                         dropout_rate=self.dropout_rate,
                         training=training)(en_in, en_mask=en_mask)
...
def train(batch_size: int, vocab_size: int, max_seq_len: int, embed_size: int, heads: int,
    ...
    train_loader, valid_loader, test_loader = load_dataset(batch_size=batch_size, n_devices=1)
...
if __name__ == '__main__':
    ...
    train(batch_size=2, vocab_size=17, max_seq_len=2000, embed_size=512, heads=8, n_layer=6,
