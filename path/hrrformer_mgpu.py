...
def train(batch_size: int, vocab_size: int, max_seq_len: int, embed_size: int, heads: int,
    ...
    train_loader, _, test_loader = load_dataset(batch_size=batch_size, n_devices=1, resolution=32, split='hard')
...
if __name__ == '__main__':
    train(batch_size=8, vocab_size=256, max_seq_len=1024, embed_size=1024, heads=8, n_layer=2,
